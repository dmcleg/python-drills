...
def count_e_in_string(string):
    ...
    for c in new_string:
        if c == "e":
            count += 1
    return count
print(count_e_in_string("The elephant bared down effortlessly on the reservoir."))
...
def length_of_string(string):
    ...
    for c in string:
        count += 1
    return count
print(length_of_string("The elephant bared down effortlessly on the reservoir."))
...
def reverse_string(string):
    ...
    return new_string
print(reverse_string("The elephant bared down effortlessly on the reservoir."))
...
def concact_elements_in_list(elements):
    ...
    for c in elements:
        result = result + c
    return result
print(concact_elements_in_list(["hello ","world"]))
